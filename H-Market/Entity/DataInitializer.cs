    ...
    public class DataInitializer:DropCreateDatabaseIfModelChanges<DataContext>
    {
        protected override void Seed(DataContext context)
        {
            ...
            var products = new List<Product>()
            {
                ...
                new Product(){Name="Apple iPhone 6 32 GB",Desciption="Apple yetkili servislerinden garanti kapsamı dahilinde ücretsiz faydalanabilirsiniz",Price=2.750,Stock=41,IsApproved= true,CategoryId=4,IsHome=false,Image="1.jpg"},
